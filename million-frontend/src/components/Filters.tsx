...
export default function Filters() {
  ...
  const inputCls = "ml-input h-10 rounded-md border border-zinc-300 px-3 text-sm shadow-sm bg-white text-black placeholder:text-zinc-500 w-full max-w-md";
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md md:w-40 md:max-w-xs">
        <span className="absolute left-2 top-1/2 -translate-y-1/2 text-zinc-500 pointer-events-none">$</span>
        <input
      ...
      <button
        type="submit"
        className="ml-btn-primary w-full max-w-md md:w-auto md:max-w-none"
      >
        Buscar
      </button>
      <button
